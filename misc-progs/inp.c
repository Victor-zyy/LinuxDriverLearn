...
/**
 * 
zyy-> cat /sys/kernel/security/lockdown 
none [integrity] confidentiality
we are lockdown mode, so we don't have the ability to test thie\s program
But I know the inherent ideas of the program
 */
