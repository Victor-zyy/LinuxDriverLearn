 ...
 * By minor number to switch case mode using iminor inline function provided by 
 * Linux Kernel
...
/**
 * __iomem is defined attribute when the macro __CHECKER__ is defined or what
 * The macro is used when static analyser runs to check via make C=1 or make C=2
 */
